    ...
    return (
        <div className="min-h-[70vh] flex items-center justify-center">
            <div className="bg-white  p-8 rounded-2xl shadow-lg w-full max-w-md">
                <h1 className="text-3xl font-extrabold text-center mb-8 text-gray-900 ">Welcome Back</h1>
                ...
                <p className="mt-8 text-center text-sm text-gray-600 ">
                    ...
                    <Link href="/auth/register" className="text-primary-600 hover:text-primary-700 font-semibold transition">
                        Sign up
                    </Link>
                </p>
            </div>
